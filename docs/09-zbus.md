...
← Previous: [8. Synchronization: locks](08-synchronization.md)

# 9. zbus

[Step 8](08-synchronization.md) protected one shared `int` with a mutex
...
---
Next → [10. Devicetree](10-devicetree.md)
