...
← Previous: [6. Threads, basics](06-threads-basics.md)

# 7. Threads, extended

[Step 6](06-threads-basics.md) got two threads running. This step covers
...
from [Step 5](05-shell.md) — reports each thread's stack usage as a
...
- Go back to the original, infinite-loop version of `apps/threads` (the
  one from [Step 6](06-threads-basics.md), still printing forever) with
...
---
Next → [8. Synchronization: locks](08-synchronization.md)
