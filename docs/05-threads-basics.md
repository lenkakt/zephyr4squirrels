...
← Previous: [4. The Zephyr shell](04-shell.md)
...
[Step 4](04-shell.md): you were already looking at more than one thread,
...
[Step 4](04-shell.md#shell_cmd_register-is-a-macro-not-a-function):
...
- **Stack size** (`STACKSIZE`, 1024 bytes here) — each thread gets its own
  ...
  [Step 6](06-threads-extended.md) is entirely about it.
...
- Add `CONFIG_SHELL=y` to [apps/threads/prj.conf](../apps/threads/prj.conf),
  like you did in Step 4. The default periods print too fast to leave you
...
---
Next → [6. Threads, extended](06-threads-extended.md)
