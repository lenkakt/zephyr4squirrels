...
← Previous: [6. Threads, extended](06-threads-extended.md)

# 7. Synchronization: locks

[Steps 5–6](05-threads-basics.md) had two threads that never touched each
...
[Step 5](05-threads-basics.md) worked at all). It just doesn't stop to ask
